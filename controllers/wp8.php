...
//http://phpwindowsphonepush.codeplex.com/SourceControl/changeset/view/18482#58320
...
class WindowsPhonePushNotification
{
    ...
    */
    public function push_toast($title, $subtitle,$json, $delay = WindowsPhonePushDelay::Immediate, $message_id=NULL)
    {
        $msg =  "<?xml version=\"1.0\" encoding=\"utf-8\"?>" .
                ...
                "<wp:json>".htmlspecialchars($json)."</wp:json>" .
                "</wp:Toast>" .
                "</wp:Notification>";
